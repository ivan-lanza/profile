    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="container-casting col-12">
          <div class="container">
            <h2 class="text-center white mt-4">Casting</h2>
            <div class="row">
                ...
                <form method="get" action="#" class="">
                    ...
                    <div class="form-group">
                      <label class="white">Cor dos olhos</label>
                      <select class="form-control">
                        <option selected>Escolha</option>
                    ...
                    <div class="col-md-5 mx-auto">
                      ...
                      <input type="number" name="" class="form-control" placeholder="De">
                    </div>

                    <div class="form-group">
                      <label class="white"></label>
                      <input type="number" name="" class="form-control" placeholder="Até">
                    </div>

                    <div class="form-group">
                      <label class="white">Cor dos cabelos</label>
                      <select class="form-control">
                        <option selected>Escolha</option>
      ...
      <div class="row">
       <div class="container-portifolio col-12">
          <div class="container">
       ...
       <div class="container-contact col-12">
          <div class="container">
            ...
            <form method="post" action="#">
              ...
              <button type="submit" class="btn btn-outline-success btn-lg btn-block mb-4">Enviar Mensagem</button>
